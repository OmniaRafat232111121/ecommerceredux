...
const Header = () => {
  return (
    ...
    <div className='w-full flex flex-col justify-between px-[40px]'>
    <ul className='flex  justify-center items-center px-[20px]'>
      ...
      <li><a className='text-2xl font-primary uppercase' href="/">Service</a></li>
      <li><a className='text-2xl font-primary uppercase' href="/">About</a></li>
