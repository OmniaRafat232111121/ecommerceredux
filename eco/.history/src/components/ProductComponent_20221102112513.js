  ...
  const renderList = products.map((product) => {
    ...
    return (
     <div className='grid grid-cols-1 lg:grid-cols-4 gap-x-4 gap-y-16  px-20 pt-12 sm:pt-20 text-black ' key={id}>
      <div className='card rounded-md w-[4=00px] h-[300px]  text-black  bg-green-600 text-bold mt-[40px] '>
    <div  className=" flex justify-center items-center">
    <img className="mt-3 rounded-md py-4 px-6" src={thumbnail} alt={title}/>
    </div>
