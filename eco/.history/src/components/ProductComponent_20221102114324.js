  ...
  const renderList = products.map((product) => {
    ...
    return (
     <div className='grid grid-cols-1 lg:grid-cols-4 gap-x-4 gap-y-16  px-20 pt-12 sm:pt-20 text-black ' key={id}>
      <div className='card rounded-md w-[200px] text-black  bg-black text-bold mt-[40px] pb-6'>
    ...
    <button className="text-bold   bg-green-800 rounded-md text-center  px-[30px] py-[10px]  text-black">{brand}</button>
  </div>
